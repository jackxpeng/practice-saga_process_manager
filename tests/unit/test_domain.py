...
def test_happy_path():
    ...
    assert evt.event_type == "CalculateRouteCommand"
    ...
    assert evt is not None
    assert evt.event_type == "RequestEmployeeApprovalCommand"
    ...
    assert evt is not None
    assert evt.event_type == "BookFlightCommand"
    ...
    assert evt is not None
    assert evt.event_type == "BookHotelCommand"
